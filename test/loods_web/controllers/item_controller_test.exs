defmodule LoodsWeb.ItemControllerTest do
  use LoodsWeb.ConnCase

  alias Loods.Parts

  @create_attrs %{description: "some description", location: "some location", name: "some name", part_number: "some part_number", quantity: 42}
  ...
  def fixture(:item) do
    {:ok, item} = Parts.create_item(@create_attrs)
    item
  end
